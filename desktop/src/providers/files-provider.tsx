...
/**
 * Selected audio/video files for the transcription page.
 *
 * The selection lives here (above the router) so navigating — including the
 * automatic hop to the translation page after a run — never loses it.
 */
